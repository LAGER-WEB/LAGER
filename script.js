...
function leerfiltrado(){
    ...
    $.ajax({
        ...
        success:  function (respuesta) {
            ...
            cabeceraTabla = "<table class=\"table table-condensed\"><thead><tr><th>id</th><th>idUsuario</th></tr></thead><tbody>";
            pieTabla = "</tbody></table>";
            contenidoTabla = "";
            $(toshow).each(function(key,value){
                contenidoTabla=contenidoTabla+"<tr><td>"+value.id+"</td><td>"+value.idUsuario+"</td></tr>";
            });
